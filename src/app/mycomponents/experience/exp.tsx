...
<div key={exp.title} className='flex flex-wrap flex-col w-[600px]   p-[40px] pb-[200px]'>
                <motion.div key={exp.title}  whileHover={{scale:1.05}} whileInView={{opacity:1,left:'0px'}} transition={{duration:0.4}} initial={{opacity:0,left:'-100px'}} className='relative flex  items-center justify-center rounded-md gap-6 ' id='ta'>
